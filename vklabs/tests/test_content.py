...
from vklabs.goose3 import ArticleContextPattern
from vklabs.goose3.text import StopWordsChinese
from vklabs.goose3.text import StopWordsArabic
from vklabs.goose3.text import StopWordsKorean
